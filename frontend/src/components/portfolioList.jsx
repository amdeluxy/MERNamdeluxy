import muestraPortfolio from '../../src/img/muestraPortfolio.jpg'
    ...
    <>
        <div className="my-8 sm:grid sm:grid-cols-2">
            <div className="mx-4 my-8 sm:mx-20">
                <h3 className="text-base text-violet-800">Featured Project</h3>
                <h2 className="text-3xl font-bold">Example Project</h2>
                <p className="text-base bg-violet-800/20 rounded-lg p-3 my-4">A web app for visualizing personalized Spotify data. View your
