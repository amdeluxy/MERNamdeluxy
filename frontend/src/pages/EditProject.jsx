  ...
  return (
    <>
        ...
        <div className="flex justify-between">
          <div>
              <h1 className="text-4xl font-black text-black ">Edit Project: <span className=" text-violet-700">{name} </span> </h1>
          </div>
          <div className="flex items-center gap-2 text-gray-400 hover:text-black">
            ...
            <button
                className="font-bold uppercase hover:text-violet-600"
                onClick={handleClick}
            >Delete</button>
          </div>
